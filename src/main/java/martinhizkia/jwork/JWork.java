...
//        }
//        try {
//            DatabaseInvoice.addInvoice(new EwalletPayment(13, myJob1, DatabaseJobSeeker.getJobseekerById(25)));
//        }
//        catch (OngoingInvoiceAlreadyExistsException | JobseekerNotFoundException e) {
//            e.printStackTrace();
//        }
...
//
//        try {
//            DatabaseInvoice.getInvoiceById(13);
...
public class JWork {
    ...
    public static void main(String[] args) {
        ...
        DatabaseRecruiter.addRecruiter(new Recruiter(1, "Martin", "martin@example.com", "123123123", location1));
